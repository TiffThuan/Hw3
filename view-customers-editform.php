            ...
            <div class="modal-body">
                <form class="row g-3" method="post" action="">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="cFName<?php echo $customer['customer_id']; ?>" name="cFName" value="<?php echo htmlspecialchars($customer['firstname']); ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="cLName<?php echo $customer['customer_id']; ?>" class="form-label"> Last Name</label>
                        <input type="text" class="form-control" id="cLName<?php echo $customer['customer_id']; ?>" name="cLName" value="<?php echo htmlspecialchars($customer['lastname']); ?>">
                    </div>
                    <div class="col-12">
                        <label for="cEmail<?php echo $customer['customer_id']; ?>" class="form-label">Email</label>
                        <input type="email" class="form-control" id="cEmail<?php echo $customer['customer_id']; ?>" name="cEmail" value="<?php echo htmlspecialchars($customer['email']); ?>">
                    </div>
                    <div class="col-12">
                        <label for="cPhone<?php echo $customer['customer_id']; ?>" class="form-label"> Phone</label>
                        <input type="text" class="form-control" id="cPhone<?php echo $customer['customer_id']; ?>" name="cPhone" value="<?php echo htmlspecialchars($customer['phone']); ?>">
                    </div>
