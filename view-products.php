<h1 class="text-center mb-5 text-uppercase" style="color: #6b3e26;">Manage Products</h1>
...
<section class="mb-5">
    <h2 class="text-center mb-4" style="color: #6b3e26;">Our Coffee Shop & Products</h2>
    <div class="row g-3">
        <div class="col-md-4">
        ...
        <?php while ($product = $products->fetch_assoc()) { ?>
            <div class="col-md-6">
                <div class="card h-100 shadow-sm" style="border-radius: 10px;">
                    ...
                    <!-- Product Details -->
                    <div class="card-body">
                        <h5 class="card-title text-dark"><?php echo htmlspecialchars($product['product_name']); ?></h5>
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        <!-- Order Now -->
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#orderProductModal<?php echo $product['productid']; ?>">Order Now</button>
                        <!-- Edit Product -->
...
<!-- Catering Order Form -->
<section class="mt-5">
    <h2 class="text-center mb-4" style="color: #6b3e26;">Catering Services</h2>
