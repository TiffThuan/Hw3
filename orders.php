...
if (isset ($_POST['actionType'])) {
    switch($_POST['actionType']) {
        case "Add":
            if (insertOrder($_POST['order_date'],$_POST['customer_id'], $_POST['total_amount'])) {
        ...
        case "Edit":
            if (isset($_POST['order_id'], $_POST['order_date'],$_POST['customer_id'], $_POST['total_amount'])) {
                if (updateOrder($_POST['order_id'],$_POST['order_date'], $_POST['customer_id'], $_POST['total_amount'])) {
